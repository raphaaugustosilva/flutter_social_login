...
//   Usuario _userFromFirebase(FirebaseUser user) {
//     if (user == null) {
//       return null;
//     }
//     return User(
...
//   @override
//   Future<Usuario> criarUsuario(String email, String password) async {
...
//   @override
//   Future<Usuario> signInWithEmailAndLink({String email, String link}) async {
